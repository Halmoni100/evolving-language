...
if __name__ == '__main__':
    main(NUM_EPISODES=400, NUM_AGENTS=3, MAX_CYCLES_PER_EP=300, use_copier=False, continue_from_checkpoint=False)
    main(NUM_EPISODES=400, NUM_AGENTS=3, MAX_CYCLES_PER_EP=300, use_copier=True, continue_from_checkpoint=False, copier_ep_lookback=50)
