...
class Copier():
    def __init__(self, num_agents, ep_lookback, obs_dim, num_actions):
        ...
        self.model.add(Dense(16, kernel_initializer='he_normal', input_shape=(obs_dim,), kernel_regularizer=regularizers.l2(0.01)))
        self.model.add(LeakyReLU(alpha=0.1)),
        self.model.add(Dense(16, kernel_initializer='he_normal', kernel_regularizer=regularizers.l2(0.01)))
        self.model.add(LeakyReLU(alpha=0.1)),
